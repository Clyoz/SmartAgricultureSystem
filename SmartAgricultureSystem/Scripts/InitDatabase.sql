...
(4, 'GH-004', N'4号黄瓜大棚', N'西区D栋', 900,  N'日光温室', 2, '2024-06-01', 2, N'种植黄瓜中'),
(5, 'GH-005', N'5号蓝莓大棚', N'南区E栋', 700,  N'玻璃温室', 2, '2024-08-10', 3, N'设备维护中');
...
(5,  'DEV-SN02', N'2号传感器节点',  2, 2, '192.168.1.202', 502, 1, N'AG-SN100', 'V1.5.3', 1, '2024-06-01', N'草莓温湿度传感器'),
(6,  'DEV-GW03', N'3号网关',        3, 1, '192.168.1.301', 502, 1, N'AG-GW200', 'V2.1.0', 0, '2023-12-01', N'3号大棚网关'),
(7,  'DEV-SN03', N'3号传感器节点',  3, 2, '192.168.1.302', 502, 1, N'AG-SN100', 'V1.5.3', 0, '2023-12-01', N'育苗大棚传感器'),
(8,  'DEV-GW04', N'4号网关',        4, 1, '192.168.1.401', 502, 1, N'AG-GW200', 'V2.1.0', 1, '2024-07-01', N'4号大棚网关'),
(9,  'DEV-SN04', N'4号传感器节点',  4, 2, '192.168.1.402', 502, 1, N'AG-SN200', 'V2.0.0', 1, '2024-07-01', N'黄瓜大棚传感器'),
(10, 'DEV-SN05', N'5号传感器节点',  5, 2, '192.168.1.502', 502, 1, N'AG-SN200', 'V2.0.0', 0, '2024-09-01', N'蓝莓大棚传感器');
...
(7,  'SEN-T02', N'2号棚温度传感器',  5, 1, 0,  1, N'℃',  -20, 80,    0.1, 2000, 1),
(8,  'SEN-H02', N'2号棚湿度传感器',  5, 2, 1,  1, N'%',   0,   100,   0.1, 2000, 1),
(9,  'SEN-T03', N'3号棚温度传感器',  7, 1, 0,  1, N'℃',  -20, 80,    0.1, 2000, 1),
(10, 'SEN-H03', N'3号棚湿度传感器',  7, 2, 1,  1, N'%',   0,   100,   0.1, 2000, 1),
(11, 'SEN-L03', N'3号棚光照传感器',  7, 3, 2,  1, N'Lux', 0,   120000, 1,   5000, 1),
(12, 'SEN-T04', N'4号棚温度传感器',  9, 1, 0,  1, N'℃',  -20, 80,    0.1, 2000, 1),
(13, 'SEN-H04', N'4号棚湿度传感器',  9, 2, 1,  1, N'%',   0,   100,   0.1, 2000, 1),
(14, 'SEN-SM04',N'4号棚土壤湿度',    9, 4, 3,  1, N'%',   0,   100,   0.1, 3000, 1),
(15, 'SEN-T05', N'5号棚温度传感器',  10, 1, 0,  1, N'℃',  -20, 80,    0.1, 2000, 1),
(16, 'SEN-H05', N'5号棚湿度传感器',  10, 2, 1,  1, N'%',   0,   100,   0.1, 2000, 1);
